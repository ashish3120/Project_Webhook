<div align="center">
  <h1>🚀 Reliable Webhook Delivery Service</h1>
  <p><i>A production-ready, multi-tenant, asynchronous webhook delivery platform.</i></p>

  ![Java 21](https://img.shields.io/badge/Java-21-blue?style=for-the-badge&logo=java)
  ![Spring Boot](https://img.shields.io/badge/Spring_Boot-4.1.0-brightgreen?style=for-the-badge&logo=spring)
...
It guarantees **at-least-once delivery**, enforces strict **tenant isolation**, and ensures **high availability** and concurrency utilizing database-level locking.
...
> [!IMPORTANT]
> **For Windows PowerShell users:** use `curl.exe` instead of `curl` to bypass the built-in alias.
...
## 🛡️ 7. Security & Resilience Models
...
### ♻️ Fault Tolerance & Crash Recovery
